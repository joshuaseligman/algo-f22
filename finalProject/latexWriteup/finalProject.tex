...
\lstinputlisting[caption = Variation Stable Matching Algorithm (C++), label = lst:variation, language = C++, firstline = 112, lastline = 261, firstnumber = 1]{./../residentVariation/stableMatching.cpp}
